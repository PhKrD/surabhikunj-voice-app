...
export default function WhatsAppShareModal({ title = 'Share Report', initialMessage, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg max-h-[90vh] flex flex-col bg-white rounded-3xl shadow-2xl overflow-hidden"
      ...
      >
        ...
        <div className="p-5 space-y-3 overflow-y-auto">
          ...
          <textarea
            ...
            className="w-full px-3 py-3 rounded-2xl border border-slate-200 bg-slate-50 text-sm text-slate-800 font-mono leading-relaxed focus:outline-none focus:ring-2 focus:ring-saffron-300"
          />
        </div>
