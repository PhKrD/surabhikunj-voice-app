-- ============================================================
-- RESET + FULL MIGRATE (Option A)
-- DANGER: drops all user tables, types, functions in public schema
-- Run only in a fresh or intentionally-empty Supabase project
-- ============================================================
...
BEGIN
  ...
  -- Drop all custom enum/composite types in public
  FOR r IN (
    SELECT t.typname
    FROM pg_type t
  ...
  -- Drop all functions in public that are not Supabase extension helpers
  FOR r IN (
...
-- ============================================================
-- VOICE + Parental Control — Full Schema (migrations 01–52)
-- Generated Tue Aug 11 14:18:33 IST 2026
-- Schema files first, seed files last
-- ============================================================
